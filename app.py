...
st.markdown("### *'Moviendo cuerpos, conectando mentes: La calle es salud mental en movimiento'*")
st.divider()
...
st.sidebar.write("Análisis de las propuestas para la asignatura de Educación Física en centros educativos de Castilla y León.")